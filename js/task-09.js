...
const refs = {
  outputFieldEl: document.querySelector('.color'),
  changeColorBtnEl: document.querySelector('.change-color'),
};

refs.changeColorBtnEl.addEventListener('click', onClickChangeColorBtn);

function onClickChangeColorBtn() {
  refs.outputFieldEl.textContent = `${getRandomHexColor()}`;
